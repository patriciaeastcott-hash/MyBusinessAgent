...
def generate_ai_image(prompt: str, output_filepath: Path) -> bool:
    ...
    try:
        ...
        try:
            ...
            # 🟢 --- FIX: Replaced PNG data with a valid 1x1 black JPEG placeholder ---
            placeholder_jpg_b64 = ""
            
            with open(output_filepath, "wb") as f:
                f.write(base64.b64decode(placeholder_jpg_b64))
